<?php
// Orders page with search, filters, pagination, static per-order modals
session_start();
...
// Fetch with filters (replace with real query logic in your database class)
try {
                  ...
                  <td>
                    <form method="post" class="d-flex">
                      <select name="order_status" class="form-select form-select-sm me-2">
                        <?php 
                          $statuses = ['Pending'=>'secondary','Processing'=>'info','Shipped'=>'primary','Completed'=>'success','Cancelled'=>'danger'];
